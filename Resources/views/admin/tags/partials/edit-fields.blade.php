<div class="box-body">
    <div class='form-group{{ $errors->has("{$lang}[title]") ? ' has-error' : '' }}'>
        {!! Form::label("{$lang}[title]", trans('blog::tag.form.name')) !!}
        <?php $old = $tag->hasTranslation($locale) ? $tag->translate($lang)->title : '' ?>
        {!! Form::text("{$lang}[title]", Input::old("{$lang}[title]", $old), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('blog::tag.form.name')]) !!}
